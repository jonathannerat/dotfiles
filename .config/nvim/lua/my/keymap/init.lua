...
local mappings = {
	...
	["n|<leader>gt"] = map_cr('tabmove+'):with_noremap():with_silent(),
	["n|<leader>gT"] = map_cr('tabmove-'):with_noremap():with_silent(),
	["n|<leader>hh"] = map_cr('noh'):with_noremap():with_silent(),
	["n|<leader>ht"] = map_cr([[/\s\+$]]):with_noremap():with_silent(),
	["n|<leader>lg"] = map_cr('LazyGit'):with_noremap():with_silent(),
	["n|<leader>lG"] = map_cr('LazyGitConfig'):with_noremap():with_silent(),
