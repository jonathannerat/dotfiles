...
local mappings = {
	...
	["n|<leader>ci"] = map_cr('edit ' .. global.lua_dir .. '/my/init.lua'):with_noremap(),
	["n|<leader>cp"] = map_cr('edit ' .. global.lua_dir .. '/my/plugins.lua'):with_noremap(),
	["n|<leader>co"] = map_cr('edit ' .. global.lua_dir .. '/my/options.lua'):with_noremap(),
	["n|<leader>ck"] = map_cr('edit ' .. global.lua_dir .. '/my/keymap/init.lua'):with_noremap(),
	...
	["n|<leader>ft"] = map_cr('Telescope treesitter'):with_noremap(),
	...
	["n|<leader>sr"] = map_cr('SudaRead'):with_noremap(),
	["n|<leader>sw"] = map_cr('SudaWrite'):with_noremap(),
	["n|<leader>S"]  = map_cr('Startify'):with_noremap(),
