...
local mappings = {
	...
	["n|ns|<leader>ci"] = m.cmd([[exe 'e ' .. stdpath('config') .. '/lua/my/init.lua']]),
	["n|ns|<leader>ck"] = m.cmd([[exe 'e ' .. stdpath('config') .. '/lua/my/keymap/init.lua']]),
	["n|ns|<leader>co"] = m.cmd([[exe 'e ' .. stdpath('config') .. '/lua/my/options.lua']]),
